# https://py2.codeskulptor.org/#user50_Fy1a6tjTZCO8RxD.py
...
class Sprite:
    ...
    def collide (self, other):
        if dist(self.pos, other.get_pos()) > self.radius + other.get_radius():
            return False
        return True
...
def draw(canvas):
    global time, started, score, lives, rock_group, my_ship, explosion_group, missile_group
    # animiate background
    time += 1
    wtime = (time / 4) % WIDTH
